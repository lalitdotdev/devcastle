...
import {
    ArrowUpRight, MessageSquare, Share2,
    Globe2, Clock, ChevronRight,
} from "lucide-react";
...
const ACCENTS = [
    { dot: "bg-violet-400",  bar: "from-violet-500",  glow: "group-hover:shadow-violet-500/8",  community: "text-violet-400 hover:text-violet-300"  },
    { dot: "bg-cyan-400",    bar: "from-cyan-500",    glow: "group-hover:shadow-cyan-500/8",    community: "text-cyan-400 hover:text-cyan-300"      },
    { dot: "bg-fuchsia-400", bar: "from-fuchsia-500", glow: "group-hover:shadow-fuchsia-500/8", community: "text-fuchsia-400 hover:text-fuchsia-300" },
    { dot: "bg-amber-400",   bar: "from-amber-500",   glow: "group-hover:shadow-amber-500/8",   community: "text-amber-400 hover:text-amber-300"    },
    { dot: "bg-emerald-400", bar: "from-emerald-500", glow: "group-hover:shadow-emerald-500/8", community: "text-emerald-400 hover:text-emerald-300" },
    { dot: "bg-rose-400",    bar: "from-rose-500",    glow: "group-hover:shadow-rose-500/8",    community: "text-rose-400 hover:text-rose-300"      },
];
        ...
        <>
                ...
                >
                    ...
                    <div className="p-5 pl-6">
                        ...
                        {/* ── Title + Content ── */}
                        <a href={`/cb/${communityName}/post/${post.id}`} className="block group/title">
                            <h2 className="text-sm font-semibold text-zinc-200 group-hover/title:text-white transition-colors leading-snug mb-2"
