...
export default function About() {
    return (
        <>
                ...
                <div className="font-mono col-start-6 col-span-5 max-w-xl lg:max-w-none text-lg md:text-2xl  leading-[130%] text-light-gray font-medium space-y-7">
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <div className="text-primary text-base xl:text-h6 2xl:text-h5 font-medium flex flex-col">
                            <p className=" leading-tight text-color-5 font-semibold ">Lalit Sharma</p>
                            <Clipboard />
                        </div>
                    </div>
                </div>
            ...
            <h2 className="mt-8 font-semibold text-lg md:text-2xl self-start mx-5 xs:mx-10 sm:mx-12 md:mx-16 lg:mx-20 text-n-14 dark:text-light dark:font-normal ">
