...
import { rejectProduct } from "@/lib/launchpad-server-actions/server-actions";
    ...
    return (
        <div className="h-full overflow-auto">
            <div>
                ...
                <div>
                    <h1 className="text-emerald-50 py-4 font-semibold">
                        Reason for rejection
                    </h1>

                    <textarea
                        onChange={(e) => setReason(e.target.value)}
                        className="w-full p-2 rounded-md border border-emerald-600 focus:outline-none bg-gray-800"
