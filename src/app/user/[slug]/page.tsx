...
const Page = async ({ params }: pageProps) => {
  ...
  return (
    <div>
      <main className="mx-auto my-6 w-full px-4 sm:max-w-5xl lg:max-w-4xl lg:px-8">
        <div className="dark:border-gray-600 mb-4">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center w-full">
              <div className="text-center">
                <div className="sm:m-0 shadow-lg rounded-full overflow-hidden h-[86px] w-[86px] md:h-[100px] md:w-[100px]">
                  <Image src={profile?.image} width={500} height={500} alt="" />
                </div>
              </div>
              <div className="w-full">
                <div className="flex flex-col md:flex-row flex-wrap items-center justify-center md:justify-between md:flex-no-wrap mb-2 md:mb-0 gap-2">
          ...
          {session?.user.id === profile?.id && (
            <div className="flex w-full flex-wrap justify-center sm:w-auto sm:justify-start gap-x-4 gap-y-1 md:ml-28">
        ...
        <div>
          <Tabs defaultValue="articles" className="w-full ">
            <div className="border-b border-gray-400 md:font-semibold">
              <TabsList className="grid md:w-[50%] grid-cols-4 ">
