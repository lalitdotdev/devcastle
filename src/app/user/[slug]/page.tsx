        ...
        <div className="flex flex-col md:flex-row gap-4 items-center md:justify-between">
          <div className="flex flex-col md:flex-row gap-4 items-center w-full">
            ...
            <div className="w-full">
              <div className="flex x flex-wrap items-center justify-center md:justify-between md:flex-no-wrap mb-2 md:mb-0 gap-2">
                <h2 className="flex items-center md:text-4xl text-2xl text-indigo-500 font-bold break-words capitalize">
                  {profile?.name}
                </h2>
