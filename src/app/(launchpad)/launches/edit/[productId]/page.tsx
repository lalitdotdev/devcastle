...
import { getProductById, getRankById } from "@/lib/launchpad-server-actions/server-actions";
...
const ProductIDPage = async ({ params }: { params: IParams }) => {
    ...
    return (
        <div className="md:w-4/5 mx-auto px-6 md:px-0 py-10 md:py-16 ">
            <Link href="/launchpad/my-products" className="flex gap-x-4">
                <ArrowLeft className="text-2xl text-gray-500" />
                <p> Go Back</p>
            </Link>
            ...
            <div className="flex items-center justify-between py-4 ">
                <div className="flex items-center gap-x-4 ">
                    <Image
                        ...
                        width={500}
                        height={500}
                        className="h-20 w-20 md:h-40 md:w-40 border border-teal-600 border-dashed rounded-lg"
                    />
