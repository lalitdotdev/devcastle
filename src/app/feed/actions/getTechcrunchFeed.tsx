...
export async function getTechCrunchFeed() {
    try {
        ...
        const entries = result.rss.channel.item.map((item: any) => ({
            ...
            categories: Array.isArray(item.category)
                ...
                : item.category
                    ...
                    : [],
            content: item.description, // TechCrunch uses 'description' for full content
        ...
        console.error("Failed to fetch or parse TechCrunch feed:", error);
        return [];
    }
}
